...
function adminBindSocket (socket) {
    ...
    document.querySelector("#swap_buffers_0").onclick = () => socket.emit("swapBuffers", { front: 0 })
    document.querySelector("#swap_buffers_1").onclick = () => socket.emit("swapBuffers", { front: 1 })
}
